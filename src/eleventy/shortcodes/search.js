const search = function (texts) {
  ...
  return /* html */ `
    ...
    <script type="text/plain" template="amp-mustache" id="search-item-template"><article class="search-box__article"><header class="article__header"><p><a href="{{item.url}}">{{item.title}}</a></p></header><section class="article__content"><p>{{item.description}}</p></section></article></script>
  `;
};
