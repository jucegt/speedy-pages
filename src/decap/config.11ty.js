...
const config = {
  ...
  render: async function ({ config, locale }) {
    ...
    const configFile = file
      ...
      .replace(/'{{settings.ui.label}}'/gi, texts.settings.ui.label)
      .replace(/'{{settings.ui.colors.label}}'/gi, texts.settings.ui.colors.label)
      .replace(/'{{settings.ui.colors.primary.label}}'/gi, texts.settings.ui.colors.primary.label)
      .replace(/'{{settings.ui.colors.primary.hint}}'/gi, texts.settings.ui.colors.primary.hint)
      .replace(/'{{settings.ui.colors.secondary.label}}'/gi, texts.settings.ui.colors.secondary.label)
      .replace(/'{{settings.ui.colors.secondary.hint}}'/gi, texts.settings.ui.colors.secondary.hint)
