const en = {
  posts: {
    ...
    seo: {
      ...
      slug: {
        label: 'Slug',
        hint: 'Link structure displayed in the navigation bar.',
      },
      description: {
        label: 'Description',
    ...
    info: {
      ...
      title: {
        label: 'Title',
        hint: 'Title displayed in the post page.',
      },
      category: {
        label: 'Category',
        hint: 'Category displayed in the post page.',
      },
      date: {
        label: 'Publish Date',
        hint: 'Date displayed in the post page.',
      },
      author: {
        label: 'Author',
        hint: 'Name displayed in the post page.',
      },
      excerpt: {
        label: 'Excerpt',
  ...
  categories: {
    ...
    info: {
      ...
      showMenu: {
        label: 'Show in menu',
        hint: 'Show category in the navigation bar.',
      },
      title: {
        label: 'Title',
        hint: 'Title displayed in the category page.',
      },
      body: {
        label: 'Body',
        hint: 'Content displayed in the category page.',
      },
    },
  },
  authors: {
  ...
  pages: {
    ...
    content: {
      ...
      title: {
        label: 'Title',
        hint: 'Title displayed in the page.',
      },
      body: {
        label: 'Body',
